...
<div class="hero-one mt-h w-full p-rel">
    <div class="container h-full">
        <div class="heroOneSwiper swiper">
            <div class="swiper-wrapper">
                ...
                ?>
                    <div class="swiper-slide">
                        <div class="hero-one-slider flex flex-row p-rel jc-sb flex-wrap ">
                            <div class="hero-one-slider-right md-show flex-row global-image">
                                <?= Media::simpleImage($image);?>
                            </div>
                            <div class="hero-one-slider-left">
                            ...
                            <div class="hero-one-slider-right md-hide jc-fe flex flex-row global-image">
                                <?= Media::simpleImage($image);?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="hero-one-pagination pagination-swiper">
                <div class="swiper-pagination-hero-one"></div>
            </div>
        </div>
    </div>
</div>